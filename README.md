...
| 화면 | 주소 | 비밀번호 |
|------|------|---------|
| **학생 진입 (도메인)** | https://데이터통신-김준선.kro.kr/ | 없음 (익명) |
| **교수 관리 (도메인)** | https://데이터통신-김준선.kro.kr/admin | `4870` |
| 학생 진입 (Vercel) | https://lecture-qna-kappa.vercel.app/ | 없음 |
| 교수 관리 (Vercel) | https://lecture-qna-kappa.vercel.app/admin | `4870` |
...
### 학생 (입장)
- QR 코드 스캔 → 자동 입장 OR 3자리 숫자 코드 직접 입력
...
- **세션 코드 형식** — 숫자 3자리 (000~999, 1000 조합). 강의실에서 입으로 부르기/외우기 쉬움. 충돌 시 자동 재생성 (최대 8회 재시도).
